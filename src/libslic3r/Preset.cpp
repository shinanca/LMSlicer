...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bridge_speed", "gap_fill_speed", "gap_fill_enabled", "travel_speed", "travel_speed_z", "first_layer_speed", "first_layer_infill_speed","first_layer_speed_over_raft", "perimeter_acceleration", "infill_acceleration",
...
static std::vector<std::string> s_Preset_filament_options {
    ...
    "extrusion_multiplier", "enable_pressure_advance", "pressure_advance", "filament_density", "filament_cost", "filament_spool_weight", "filament_loading_speed", "filament_loading_speed_start", "filament_load_time",
